...
export default function Jobs({ t, changeLn, selectedLanguage }) {
  return (
    <div>
      <Helmet>
        ...
        />
        <meta property="og:url" content="https://www.techknowgram.com/job" />

        <meta property="url" content="https://www.techknowgram.com/job" />
        ...
        <link rel="canonical" href="https://www.techknowgram.com/job" />
      </Helmet>
      <Nav1 t={t} changeLn={changeLn} selectedLanguage={selectedLanguage} />
      <Banner image={homebanner} header={"Jobs"} />
