  ...
  en: {
    translation: {
      ...
      TechknowGramLimitedoffers:
        "TechknowGram Limited offers its own Enterprise Resource Planning solution called TKG ERP, which can be tailored to meet",
      TechknowGramLimitedoffers2:
        "the unique needs of any business entity, including those in the Construction Industry, Education, Manufacturing, Workshops, and RMG industry. This ERP is developed and supported with the latest 4IR technology.",

      QuizWin:
        "QuizWin is an interactive quiz platform for knowledge enthusiasts, as its name implies.We offer a range of quiz events",
      QuizWin2:
        "that users can participate in and potentially win prizes. The leaderboard provides a complete competitive experience.Ideal solution for effectively organize for any Quiz or assessment even",
      Prostuti:
        "TechKnowGram has created Prostuti,an exam management platform for institutes to administer exams. The",
      Prostuti2:
        "platform was designed with the goal of automating the exam process, which can often be tedious and repetitive. Prostuti simplifies the entire process and provides convenience for both examiners and examinees. It streamlines exam arrangements, management, and attendance, making the entire experience more efficient and user-friendly.",
      Khoz: "KHOZ is a recently developed project for Beacon-based Indoor Navigation System that incorporates IoT   ",
      Khoz2:
        "  technology to deliver precise and up-to-date location data to users navigating indoor environments. The system operates by using beacons - small, cost-effective, and battery-powered devices that emit a Bluetooth signal that mobile devices like smartphones can detect. Ideal solution for event management at supermarkets for location and promotions. ",
      BMS: "The Roads and Highways Department (RHD) of Bangladesh Government is  ",
      
      Chatbot:" Booking management is a crucial component of an Appointment Scheduling Chatbot, designed to ",
      Chatbot2:"  streamline the process of scheduling appointments efficiently and conveniently for users. Here's how you can implement and optimize booking management features: ",
      BMS2: "  responsible for maintaining and managing  the country's road and bridge infrastructure. To ensure the safety and reliability of bridges, the RHD has adopted the use of Bridge Management System (BMS) software. BMS is a comprehensive tool that helps Bridge Management Wing (BMW) of RHD to monitor the health and performance of bridges, assess their performance, and schedule maintenance and repair work. The four key components of a BMS system that the RHD can use to manage its bridges effectively are Bridge Basic Data Input, Bridge Inspection, Bridge Evaluation and Bridge Remedy.",
      CustomSolutionDevelopmentTitle: "Custom Solution Development",
      CustomSolutionDevelopment:
        "Analysts & Developers of TechKnowGram Limited love creating application and",
      CustomSolutionDevelopment2:
        " tools to solve your specific business issues but, our first job, as creative software specialists, is to listen you. We want to hear about your business challenges so that we can help you to solve them.      ",
      SkillMigrationTitle:
      ...
      KentaKatoDesc: "TechKnowGram delivered our work quickly and provided designs that attracted both our clients and partners, while also eliminating the need for a business analyst. They offer a complete solution for all client requirements, making them a valuable asset for any customer.",

      HirokazuYoshidaDesc: "Ahmedul had been brilliant in getting my work done. He and his team are problem solvers and provided a spontaneous vision of how to build on and clarify whatever was requested. TechKnowGram is praised for its ability to develop workable solutions and for its attention to professional service",
      KinyaIshiiDesc: "TechKnowGram and Ahmedul worked for us for quite some time. The whole team of Ahmedul became solution provider. They presented a remarkable positive attitude. All the work was done in a short span of time and the team achieved the impossible",

      MalligaSubramaniumDesc: "TechKnowGram’s team provided fast and flexible service with considerable expertise. Their unique approach to assessing feedback helped me solve my problem. Ahmed, their leader, is highly regarded for his unwavering commitment to justice.",
      FooterAboutOne: "TechKnowGram Limited is a global solution provider led by experts having more than 25 years of professional experiences in both the local and global arena specially for Japan ICT market for last 20 years as well as USA & Europe market.",
      FooterAboutTwo: " The company particularly provides web-based customized solutions on ERP, AI, Data Analytics, Robotics, Embedded Solutions with Beacon, AR, VR Applications and Gaming and Animation.",
      AddressLineOne: "5/9 Block B, Lalmatia, Mohammadpur",
      AddressLineTwo: "Dhaka 1207, BANGLADESH",
      AddressContact: "Phone:+88 02 55008199",
  ...
  jp: {
    translation: {
      ...
      AIARVR2:
        ...
        KentaKatoDesc: "TechKnowGram は私たちの仕事を迅速に提供し、ビジネス アナリストの必要性をなくしながら、クライアントとパートナーの両方を惹きつけるデザインを提供してくれました。 クライアントのすべての要件に完全なソリューションを提供し、あらゆる顧客にとって貴重な資産となります。",

      HirokazuYoshidaDesc: "アーメドゥルは私の仕事を成し遂げるのに優れていました。 彼と彼のチームは問題解決者であり、要求されたものをどのように構築して明確にするかについて自発的なビジョンを提供しました. TechKnowGram は、実行可能なソリューションを開発する能力と、専門的なサービスへの注意が高く評価されています。",
      KinyaIshiiDesc: "TechKnowGram と Ahmedul は、かなり長い間、私たちのために働いてくれました。 Ahmedul のチーム全体がソリューション プロバイダーになりました。 彼らは驚くべき前向きな姿勢を示しました。 すべての作業は短期間で完了し、チームは不可能を達成しました",
      MalligaSubramaniumDesc: "TechKnowGram のチームは、かなりの専門知識を備えた迅速で柔軟なサービスを提供しました。 フィードバックを評価する彼らのユニークなアプローチは、私の問題を解決するのに役立ちました. 彼らのリーダーであるアーメドは、正義への揺るぎないコミットメントで高く評価されています。",
      FooterAboutOne: "TechKnowGram Limited は、過去 20 年間、特に日本の ICT 市場と米国およびヨーロッパ市場向けに、ローカルおよびグローバルの分野で 25 年以上の専門的経験を持つ専門家が率いるグローバル ソリューション プロバイダーです。",
      catAll: "すべてのカテゴリ",
      FooterAboutTwo: " 同社は特に、ERP、AI、データ分析、ロボティクス、ビーコンを使用した組み込みソリューション、AR、VR アプリケーション、ゲームとアニメーションに関する Web ベースのカスタマイズされたソリューションを提供しています。",
