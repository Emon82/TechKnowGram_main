...
const resources = {
  en: {
    translation: {
      ...
      FooterAboutOne:
        "TechKnowGram Limited is a global solution provider led by experts having more than 25 years of professional experiences in both the local and global arena specially for Japan ICT market for last 20 years as well as USA & Europe market.",
      FooterAboutTwo:
        " The company particularly provides web-based customized solutions on ERP, AI, Data Analytics, Robotics, Embedded Solutions with Beacon, AR, VR Applications and Gaming and Animation.",
